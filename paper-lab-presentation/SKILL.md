...
7. Produce output.
   ...
   - If requested, produce a Typst .typ slide deck (see references).
...
- Q&A prep list.
- Typst slide deck (.typ) when asked.

## References

- Use `references/presentation_guide.md` for templates, checklists, and phrasing patterns.
- Use `references/typst_slides.md` for Typst slide deck conventions and minimal structure.
